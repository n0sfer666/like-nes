...
// Общая обстановка двух гейтов файла реплея: счётчик отказов, переписывание файла целиком и сборка
// заголовка. Заведена, когда перечисление порч переросло мягкий лимит длины и гейт разделили на две
// цели по предмету — доносит ли файл ТОТ ЖЕ прогон и тотален ли читатель (аудит #21, ревью A·2·3).
