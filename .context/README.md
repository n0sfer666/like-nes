...
| 6 | Система плагинов + конфигурируемый интерфейс | **В работе** (ADR 0006 Proposed; PoC T4: гейты 1-4+6 зелёные — детерм.-реестр/топосорт, C-ABI seam, крэш-изоляция+hot-reload, 6 ext-point, манифест→докируемые ImGui-панели live-подтверждены owner; **осталось только WASM gate 5** — отложен owner, тулчейн) — [`specs/2026-07-21-plugin-system.md`](specs/2026-07-21-plugin-system.md) |
