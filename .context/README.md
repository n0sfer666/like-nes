...
| 13 | Паритет среды разработки на трёх десктопных ОС | **Закрыта частично** (ADR 0013 Proposed; гейты 1–5 и 7 зелёные на 3 ОС: shmem-зеркало, Play-spawn, build-loop с живым `cl.exe`, диагностики MSVC, перф, кросс-ОС сцена. Единственный `if(NOT WIN32)` в дереве — `ide_ipc_bench`, постоянная граница. **Гейты 6 (X11+Wayland) и 8 (сквозной сценарий) ждут VM владельца** — до них ADR не Accepted) — [`specs/2026-07-26-desktop-dev-parity.md`](specs/2026-07-26-desktop-dev-parity.md) · [`decisions/2026-07-27-desktop-dev-parity.md`](decisions/2026-07-27-desktop-dev-parity.md) |
