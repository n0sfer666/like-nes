...
| 6 | Система плагинов + конфигурируемый интерфейс | **В работе** (ADR 0006 Proposed; native-вертикаль PoC T4: гейты 1-4+6-headless зелёные — детерм.-реестр/топосорт, C-ABI seam, крэш-изоляция+hot-reload, 6 ext-point, манифест→докируемые панели; WASM gate 5 отложен owner, live-UI ждёт owner) — [`specs/2026-07-21-plugin-system.md`](specs/2026-07-21-plugin-system.md) |
