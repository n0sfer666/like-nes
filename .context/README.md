...
| 8 | Билд/деплой и кросс-компиляция | **В работе** (ADR 0008 Proposed, 3 research-развилки закрыты: тулчейн=native-matrix+mobile-cross / детерм.=P0–P3 per-triple / упаковка=.app+tarball+папка; walking-skeleton S1 done, S2–S11 open) — [`specs/2026-07-23-build-deploy.md`](specs/2026-07-23-build-deploy.md) · [`decisions/2026-07-23-build-deploy.md`](decisions/2026-07-23-build-deploy.md) |
