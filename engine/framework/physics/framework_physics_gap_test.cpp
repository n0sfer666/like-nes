...
void test_core_gap() {
    ...
    Manifold m;
    check(collide(make_body(a), make_body(b), SPECULATIVE_MARGIN, m), "collinear capsules overlapping by radius collide");
    ...
    check(!collide(make_body(a), make_body(b), SPECULATIVE_MARGIN, m), "the segment axis rejects collinear capsules apart");
    ...
    check(!collide(make_body(a), make_body(b), SPECULATIVE_MARGIN, m), "the core-gap path rejects a pair 8.54 apart");
    ...
    check(collide(make_body(a), make_body(b), SPECULATIVE_MARGIN, m), "the core-gap path accepts the same pair 6.7 apart");
    ...
    check(collide(make_body(a), make_body(b), SPECULATIVE_MARGIN, m), "parallel capsules collide");
