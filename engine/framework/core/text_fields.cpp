...
// разрядности за пределами Q16.16 отбрасывается, а не отвергается: 0.0000001 это законный способ
// написать «почти ноль», и требовать от автора знания шага сетки нечестно.
