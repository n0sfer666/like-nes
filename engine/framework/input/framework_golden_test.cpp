...
//
// Эталон перезаписан 2026-08-01: у `move_x` тут ДВЕ строки, и прежнее значение
// (`0x23d71ef8855fa5c1`) было снято со сломанной маршрутизации — стик уезжал в `move_y`. Хеш
// пинил дефект, поэтому его смена и есть подтверждение фикса, а не его следствие.
namespace {
