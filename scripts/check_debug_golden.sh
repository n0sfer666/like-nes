...
debug_golden() {
    ...
    local t bin out rc=0 golden="" traj="" baked="" tiles="" maps="" plat="" anim="" cpath="" cview="" atlas="" overlay="" batch="" tdraw="" parts=""
