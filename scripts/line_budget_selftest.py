...
"""
from line_budget_rules import HARD, SOFT
...
CASES = [
    ...
    ("вид не из списка", "не из закрытого списка",
     ...
     {"a.cpp": SOFT + 3}, {"a.cpp": GOOD}),
    ("вид text на исходнике", "вид 'text'",
     {"a.hpp": SOFT + 3}, {"a.hpp": (SOFT + 3, "text", "причина из нескольких слов тут")},
     {"CMakeLists.txt": SOFT + 3}, {"CMakeLists.txt": (SOFT + 3, "text", "причина из нескольких слов")}),
