...
say "  #22 гейт 9 ОТКРЫТ НАПОЛОВИНУ — сходимость пары по проводу: ДВЕ машины, один коммит, --listen и --at; «играется ли» спросить нечем, окна у пира нет (§14 руководства)"
